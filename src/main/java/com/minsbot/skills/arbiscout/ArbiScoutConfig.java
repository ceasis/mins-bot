...
@Configuration
public class ArbiScoutConfig {

    @Bean
    @ConfigurationProperties(prefix = "app.skills.arbiscout")
    public ArbiScoutProperties arbiScoutProperties() {
        return new ArbiScoutProperties();
    }

    public static class ArbiScoutProperties {
        private boolean enabled = false;
        private int timeoutMs = 8000;
        private int maxFetchBytes = 2_000_000;
        private int maxSources = 20;
        private int maxResults = 50;
        private String userAgent = "MinsBot-ArbiScout/1.0";
