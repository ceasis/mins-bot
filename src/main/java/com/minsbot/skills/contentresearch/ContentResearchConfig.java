...
@Configuration
public class ContentResearchConfig {

    @Bean
    @ConfigurationProperties(prefix = "app.skills.contentresearch")
    public ContentResearchProperties contentResearchProperties() {
        return new ContentResearchProperties();
    }

    public static class ContentResearchProperties {
        private boolean enabled = false;
        private int timeoutMs = 8000;
        private int maxFetchBytes = 2_000_000;
        private int maxSources = 20;
        private int maxResults = 50;
        private String userAgent = "MinsBot-ContentResearch/1.0";
