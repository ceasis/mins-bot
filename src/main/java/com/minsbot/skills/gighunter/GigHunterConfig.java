...
@Configuration
public class GigHunterConfig {

    @Bean
    @ConfigurationProperties(prefix = "app.skills.gighunter")
    public GigHunterProperties gigHunterProperties() {
        return new GigHunterProperties();
    }

    public static class GigHunterProperties {
        private boolean enabled = false;
        private int timeoutMs = 8000;
        private int maxFetchBytes = 2_000_000;
        private int maxSources = 20;
        private int maxResults = 50;
        private String userAgent = "MinsBot-GigHunter/1.0";
