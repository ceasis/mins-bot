...
@Configuration
public class LeadGenConfig {

    @Bean
    @ConfigurationProperties(prefix = "app.skills.leadgen")
    public LeadGenProperties leadGenProperties() {
        return new LeadGenProperties();
    }

    public static class LeadGenProperties {
        private boolean enabled = false;
        private int timeoutMs = 8000;
        private int maxFetchBytes = 2_000_000;
        private int maxSources = 20;
        private int maxResults = 50;
        private String userAgent = "MinsBot-LeadGen/1.0";
