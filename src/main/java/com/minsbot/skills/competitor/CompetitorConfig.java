...
public class CompetitorConfig {
    ...
    @Bean
    @ConfigurationProperties(prefix = "app.skills.competitor")
    public CompetitorProperties competitorProperties() {
        return new CompetitorProperties();
    }

    public static class CompetitorProperties {
        private boolean enabled = false;
        private int timeoutMs = 8000;
        private int maxFetchBytes = 2_000_000;
        private int maxSites = 10;
        private String userAgent = "MinsBot-Competitor/1.0";
