...
public class PcAgentService {
    ...
    public String tryExecute(String message, Consumer<String> asyncResultCallback) {
        ...
        if (lower.startsWith("open collected") || lower.contains("open minsbot_data")) {
            return openFileOrFolder(Paths.get(System.getProperty("user.home"), "minsbot_data", "collected").toString());
        }
    ...
    private String listCollected() {
        Path base = Paths.get(System.getProperty("user.home"), "minsbot_data", "collected");
