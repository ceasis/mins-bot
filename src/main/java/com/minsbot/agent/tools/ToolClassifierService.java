...
public class ToolClassifierService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            - music: play music, pause music, play [song title], play [artist name], play [album], play [genre], play [mood], listen to X, put on X, play something, play my liked songs, play my music, next song, previous song, skip track, volume up, volume down, mute, play on spotify, what song is playing, search spotify, play/pause, stop music, current track, open spotify, louder, quieter. PREFER THIS CATEGORY for any "play X" or "listen to X" request about music/songs/artists/playlists — do NOT route such requests to browser or search.
