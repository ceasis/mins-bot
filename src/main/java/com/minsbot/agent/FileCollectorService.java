...
public class FileCollectorService {
    ...
    private static final Path COLLECT_BASE = Paths.get(System.getProperty("user.home"), "minsbot_data", "collected");
    ...
    /**
     * Collects files of a given category from all drives into ~/minsbot_data/collected/<category>/
